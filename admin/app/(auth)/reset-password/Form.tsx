...
const Form = () => {
    ...
    return (
        <FormCard title={'Réinitialiser'} handleSubmit={mutate}>
            ...
            <Input name={'token'} placeholder={'Mot de passe à 6 chiffres'} error={getInputError(errors, 'token')} required={true} />

            <Label htmlFor={'password'}>Nouveau mot de passe</Label>
            <InputPassword name={'password'} placeholder={'Entrez le nouveau mot de passe'} error={getInputError(errors, 'password')} />
